  ...
  return (
    <div className="min-h-screen flex flex-col lg:flex-row bg-white">
      ...
      <div className="lg:w-1/2 relative overflow-hidden min-h-[400px] lg:min-h-screen">
        {/* Background Image */}
        <img
          src="https://img.freepik.com/premium-photo/happy-corporate-man-office_1189614-18183.jpg"
        ...
        <div className="absolute inset-0 flex items-center">
          <div className="relative z-10 text-white px-8 md:px-12 lg:px-16 max-w-xl">
            ...
            <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold leading-tight mb-6">
              Connect with
              <span className="block text-white/90">top professionals</span>
              <span className="block text-white/80">worldwide</span>
            </h1>

            {/* Description */}
            <p className="text-lg text-white/80 mb-8 leading-relaxed">
              Join the network where opportunities find you. Connect with industry leaders, showcase your expertise, and accelerate your career growth.
            </p>
            ...
            <div className="bg-white/10 backdrop-blur-lg rounded-xl p-6 border border-white/20">
              ...
              <p className="text-white/90 italic mb-4">
                "NexusFlow transformed my career. Within 3 months, I landed my dream job at a Fortune 500 company."
              </p>
              <div className="flex items-center gap-3">
                <div className="w-10 h-10 bg-gradient-to-r from-blue-300 to-purple-300 rounded-full flex items-center justify-center text-[#1565c0] font-bold">
                  JD
                </div>
                <div>
                  <p className="font-semibold text-white">Jessica Davis</p>
                  <p className="text-sm text-white/60">Product Manager at Google</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="w-full max-w-md">
          ...
          <div className="text-center lg:text-left mb-8">
            ...
            <p className="text-gray-600">
              Join thousands of professionals already on NexusFlow
            </p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div>
              ...
              <div className="relative group">
                <User className="absolute left-3 top-1/2 -translate-y-1/2 w-5 h-5 text-gray-400 group-focus-within:text-[#1565c0] transition-colors" />
                <input
                  type="text"
                  id="fullName"
                  name="fullName"
           ...
           {/* Email */}
            ...
            <div className="flex items-start gap-3">
              <input
                ...
                onChange={handleChange}
                className="mt-1 w-4 h-4 text-[#1565c0] border-gray-300 rounded focus:ring-[#1565c0]"
                required
              />
    ...
    Sign in
          ...
          <div className="flex items-center justify-center gap-6 mt-8 pt-6 border-t border-gray-100">
            <div className="flex items-center gap-2">
              ...
              <span className="text-xs text-gray-500">10k+ joined today</span>
            </div>
            <div className="flex items-center gap-2">
            ...
            <div className="flex items-center gap-2">
              ...
              <span className="text-xs text-gray-500">Trusted network</span>
            </div>
          </div>
