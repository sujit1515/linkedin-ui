export default function AppSection() {
  return (
    <section className="bg-white text-gray-900 py-20 px-4 sm:px-6 lg:px-8 overflow-hidden">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div>
            <h2 className="text-3xl sm:text-4xl md:text-5xl font-extrabold leading-tight mb-5 tracking-tight">
              ...
              <span className="text-blue-600">Your Pocket</span>
            </h2>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-10">
              {/* Dark Mode */}
              <div className="bg-white border border-gray-200 rounded-xl p-4 flex items-start gap-3 hover:border-blue-500 transition-colors shadow-sm">
                ...
                <div>
                  <p className="font-bold text-sm text-gray-900 mb-1">Dark Mode</p>
              ...
              <div className="bg-white border border-gray-200 rounded-xl p-4 flex items-start gap-3 hover:border-blue-500 transition-colors shadow-sm">
                ...
                <div>
                  <p className="font-bold text-sm text-gray-900 mb-1">Offline Mode</p>
                  <p className="text-gray-600 text-xs leading-relaxed">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              {/* App Store */}
              <button className="flex items-center gap-3 px-5 py-3 bg-gray-900 text-white rounded-xl font-semibold text-sm hover:bg-gray-800 transition-all duration-200 hover:-translate-y-0.5 shadow-md w-full sm:w-auto justify-center sm:justify-start">
          ...
          <div className="flex justify-center lg:justify-end">
            <div className="relative w-56 sm:w-64">
              {/* Phone Shell */}
              <div className="bg-gray-100 border-4 border-gray-300 rounded-[2.5rem] shadow-2xl overflow-hidden">
                {/* Status Bar */}
                <div className="bg-white px-5 pt-3 pb-2 flex items-center justify-between border-b border-gray-200">
                  ...
                  <div className="flex items-center gap-1">
                    ...
                    {/* WiFi */}
                    <svg viewBox="0 0 24 24" fill="none" stroke="#4B5563" strokeWidth="2" className="w-3.5 h-3.5">
                      <path d="M5 12.55a11 11 0 0114.08 0M1.42 9a16 16 0 0121.16 0M8.53 16.11a6 6 0 016.95 0M12 20h.01" strokeLinecap="round" />
                    </svg>
                    {/* Battery */}
                    <div className="w-5 h-2.5 border border-gray-500 rounded-sm relative">
                      <div className="absolute inset-0.5 right-0.5 bg-gray-600 rounded-sm" />
                    </div>
                  </div>
                </div>
                ...
                <div className="bg-gray-50 min-h-[400px]">
                  ...
                  <div className="px-4 py-3 flex items-center justify-between">
                    <div className="flex items-center gap-2">
                      ...
                      <div>
                        <p className="text-gray-500 text-xs leading-none">Welcome back</p>
                        <p className="text-gray-900 text-sm font-bold leading-tight">Aditya Verma</p>
                      </div>
                    </div>
                    <button className="w-8 h-8 rounded-full bg-gray-200 border border-gray-300 flex items-center justify-center">
                  ...
                  <div className="mx-3 mb-3">
                    <div className="bg-blue-50 border border-blue-200 rounded-xl overflow-hidden">
                      ...
                      <div className="p-3">
                        <p className="text-gray-900 text-xs font-bold mb-1.5">Full Stack Development</p>
                        <div className="flex items-center justify-between text-xs text-gray-600 mb-1.5">
                          <span>65% Completed</span>
                          <span className="text-green-600 text-xs">Offline Saved</span>
                        </div>
                  ...
                  {/* Bottom Nav */}
                  <div className="flex items-center justify-around px-4 py-3 border-t border-gray-200 mt-auto">
                    {[
              ...
              {/* Glow behind phone */}
              <div className="absolute -bottom-8 left-1/2 -translate-x-1/2 w-40 h-20 bg-blue-600/10 blur-2xl rounded-full pointer-events-none" />
            </div>
          </div>
        </div>
      </div>
