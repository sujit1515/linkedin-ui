        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 items-start">
          ...
          <div className="relative">
            <div className="bg-white border border-gray-200 rounded-2xl p-5 sm:p-6 shadow-sm hover:shadow-md transition-shadow">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <div className="flex items-center gap-1.5">
                      <span className="font-bold text-base text-gray-900">Arjun Sharma</span>
                      <svg viewBox="0 0 24 24" fill="#3B82F6" className="w-4 h-4 flex-shrink-0">
                        <path d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" />
                      </svg>
                    </div>
                    <p className="text-gray-600 text-sm">Full Stack Developer</p>
                    <span className="inline-block mt-1 px-2 py-0.5 bg-blue-100 text-blue-600 text-xs font-semibold rounded-md tracking-wide">
                      AI-VERIFIED
                    </span>
                  </div>
                </div>
              ...
              <div className="bg-gray-50 rounded-xl p-4 mb-4">
                ...
                <p className="text-gray-600 text-sm mt-0.5">2021 — Present</p>
              </div>
              ...
              <div className="flex items-center justify-between flex-wrap gap-3">
                ...
                <div className="flex items-center gap-2.5 bg-gray-50 border border-gray-200 rounded-xl px-4 py-2.5 flex-shrink-0">
                  ...
                  <div>
                    ...
                    <p className="text-gray-900 font-bold text-sm leading-none">+124% this week</p>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="bg-white border border-gray-200 rounded-2xl p-5 sm:p-6 shadow-sm hover:shadow-md transition-shadow">
            ...
            <div className="flex items-center justify-between mb-6">
              <h3 className="font-bold text-base text-gray-900">Recruiter Insight</h3>
            ...
            <div className="flex flex-col items-center mb-6">
              <div className="relative w-32 h-32">
                ...
                <div className="absolute inset-0 flex items-center justify-center">
                  <span className="text-2xl font-extrabold text-blue-600">95%</span>
                </div>
              </div>
              <p className="font-bold text-gray-900 mt-3">Discoverability Score</p>
              <p className="text-gray-600 text-xs mt-1">Top 1% of candidates in your region</p>
            </div>
            ...
            {/* Contact Button */}
            <button className="w-full py-3.5 bg-gray-900 hover:bg-gray-800 text-white font-bold text-sm rounded-xl transition-all duration-200 hover:shadow-lg hover:-translate-y-0.5 active:translate-y-0">
              Contact Candidate
            </button>
          </div>
        </div>
